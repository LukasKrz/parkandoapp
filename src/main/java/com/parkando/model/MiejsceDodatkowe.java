...
public class MiejsceDodatkowe {
    ...
    public MiejsceDodatkowe(String parkId, Long parkPlaceId, Long idStudentDzienny, Date dataRezerwacjiDzienny, Long idStudentZaoczny, Date dataRezerwacjiZaoczny) {
        this.parkId = parkId;
