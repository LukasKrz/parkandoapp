...
@Entity
@Table(name = "MIEJSCEDODATKOWE")
public class MiejsceDodatkowe {
    ...
    public MiejsceDodatkowe() {
    }

    public MiejsceDodatkowe(String parkId, Long parkPlaceId, Long idStudentDzienny, LocalDate dataRezerwacjiDzienny, Long idStudentZaoczny, LocalDate dataRezerwacjiZaoczny) {
        this.parkId = parkId;
